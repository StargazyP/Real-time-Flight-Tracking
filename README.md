...
- **Interactive map** — Leaflet-based map; click a plane marker for details
...
- **Frontend**: Vue 3, Vite, Leaflet, Vue Leaflet
- **Backend**: Node.js, Express
- **APIs**: Flight and weather data via backend proxy
